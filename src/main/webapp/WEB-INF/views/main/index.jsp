<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"  import="org.activiti.engine.identity.*"%>
...
<head>
  ...
  <script>
    ...
    //if (notLogon) {
    //  location.href = '<%=request.getContextPath() %>/login.jsp?timeout=true';
   // }
  </script>
    ...
    <script src="<%=request.getContextPath() %>/js/common/bootstrap.min.js" type="text/javascript"></script>
    <script src="<%=request.getContextPath() %>/js/modules/main/main.js" type="text/javascript"></script>
    <%
      ...
      <div class="container-fluid">
        ...
        <div class="nav-collapse">
          ...
          <ul class="nav pull-right">
            <li class="dropdown">
            	<a data-toggle="dropdown" class="dropdown-toggle" href="#" title="角色：<%=session.getAttribute("groupNames")%>">
            		<i class="icon-user icon-black" style="margin-right: .3em"></i><%=user.getFirstName()%>&nbsp;<%=user.getLastName()%>/<%=user.getId()%><b class="caret"></b>
            	</a>
            	<ul class="dropdown-menu">
